"""
Django settings for MSRV project.
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(days=int(os.environ.get('ACCESS_TOKEN_LIFETIME', 10))),
    ...
    "TOKEN_VERIFY_SERIALIZER": "MSRV.apps.user.serializers.CustomTokenVerifySerializer",
